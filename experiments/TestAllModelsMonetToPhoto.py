...
model_checkpoints_monet_to_photo = {
    "Model 1 (256x256)": "../checkpoints/checkpoints_256_4/G_AB_final.pth",
    "Model 2 (128x128)": "../checkpoints/checkpoints_128_4/G_AB_final.pth",
    "Model 3 (Random Crop)": "../checkpoints/checkpoints_model3_randomcropping/G_AB_final.pth",
    "Model 4 (Grid Crop)": "../checkpoints/checkpoints_model4_gridcropping/G_AB_final.pth",
    "Model 5 (D + Crop)": "../checkpoints/checkpoints_model5_downsampling_randomcropping/G_AB_final.pth",
    "Model 6 (1 Discriminator)": "../checkpoints/checkpoints_model6_one_discriminator/G_AB_final.pth",
}
...
# Select Test Images (Monet Paintings)
test_images_path = "../datasets/monet2photo/testA"
